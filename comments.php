...
$args = array(
	...
	'comment_field'        => '<textarea id="comment" placeholder="' . esc_attr__('Write comment', 'topfit') . '" name="comment" cols="45" rows="7" aria-required="true"></textarea>',
	...
	'author' => '<div class="mkd-comment-author">
							...
							<div class="mkd-comment-author-input">
								<input id="author" name="author" placeholder="' . esc_attr__('Your full name', 'topfit') . '" type="text" value="' . esc_attr($commenter['comment_author']) . '"' . $aria_req . ' />
							</div>
						</div>',
	'email'  => '<div class="mkd-comment-email">
						...
						<div class="mkd-comment-email-input">
							<input id="email" name="email" type="text" placeholder="' . esc_attr__('Your email address', 'topfit') . '" value="' . esc_attr($commenter['comment_author_email']) . '"' . $aria_req . ' />
						</div>
					</div>',
        'url'    => '<input id="url" name="url" placeholder="' . esc_attr__( 'Website', 'topfit' ) . '" type="text" value="' . esc_attr( $commenter['comment_author_url'] ) . '" size="30" maxlength="200" />',
        'cookies' => '<p class="comment-form-cookies-consent"><input id="wp-comment-cookies-consent" name="wp-comment-cookies-consent" type="checkbox" value="yes"' . $consent . ' />' .
            '<label for="wp-comment-cookies-consent">' . esc_html__( 'Save my name, email, and website in this browser for the next time I comment.', 'topfit' ) . '</label></p>',
	)));
?>
