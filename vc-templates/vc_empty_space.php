...
foreach($sizes as $size) {
	if(!empty($$size)) {
		$data_attr['data-'.$size] = topfit_mikado_filter_px($$size);
	}
}

$data_attr['data-original-height'] = topfit_mikado_filter_px($height);

?>
<div <?php echo topfit_mikado_get_inline_attrs($data_attr); ?> class="<?php echo esc_attr(trim($css_class)); ?>" <?php echo topfit_mikado_get_module_part($inline_css); ?> >
