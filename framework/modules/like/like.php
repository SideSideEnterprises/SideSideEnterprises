<?php
class TopFitMikadoLike {

	private static $instance;

	private function __construct() {
		add_action('wp_enqueue_scripts', array( $this, 'enqueue_scripts'));
		add_action('wp_ajax_topfit_mikado_like', array( $this, 'ajax'));
		add_action('wp_ajax_nopriv_topfit_mikado_like', array( $this, 'ajax'));
	}
	...
	public function add_like() {
		...
		$title = esc_html__('Like this', 'topfit');
		if( isset($_COOKIE['mkd-like_'. $post->ID]) ){
			$class = 'mkd-like liked';
			$title = esc_html__('You already like this!', 'topfit');
		}
	...
	public function add_like_portfolio_list($portfolio_project_id){
        ...
        return '<a href="#" class="' . esc_attr( $class ) . '" data-type="portfolio_list" id="mkd-like-' . esc_attr( $portfolio_project_id ) . '-' . $rand_number . '" title="' . esc_attr( $title ) . '"></a>';
	...
	public function add_like_blog_list($blog_id){
        ...
        return '<a class="hover_icon ' . esc_attr( $class ) . '" data-type="blog_list" id="mkd-like-' . esc_attr( $blog_id ) . '-' . $rand_number . '" title="' . esc_attr( $title ) . '"></a>';
...
global $topfit_like;
$topfit_like = TopFitMikadoLike::get_instance();
