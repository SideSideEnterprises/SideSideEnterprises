...
<?php else: ?>
	<div class="mkd-iframe-video-holder">
		<iframe class="mkd-iframe-video" src="<?php echo esc_url($media['video_url']); ?>" width="500" height="281" wmode="<?php echo esc_attr('Opaque', 'topfit'); ?>" frameborder="0" allowfullscreen></iframe>
	</div>
<?php endif; ?>
