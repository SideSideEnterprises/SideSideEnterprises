...
<div class="mkd-container-inner">
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		<div class="mkd-post-content">
			<div class="mkd-post-quote clearfix" <?php if ($quote_color !== ''): ?> style="background-color: <?php echo esc_attr($quote_color); ?>" <?php endif; ?>>
				<div class="mkd-post-mark">
					<?php echo topfit_mikado_icon_collections()->renderIcon('icon_quotations', 'font_elegant'); ?>
				</div>
