<?php
$author_info_box   = esc_attr(topfit_mikado_options()->getOptionValue('blog_author_info'));
$author_info_email = esc_attr(topfit_mikado_options()->getOptionValue('blog_author_info_email'));
$social_networks   = topfit_mikado_get_user_custom_fields();
    ...
    <div class="mkd-author-description">
        <div class="mkd-author-description-inner clearfix">
            <div class="mkd-author-description-image">
                <?php echo topfit_mikado_kses_img(get_avatar(get_the_author_meta('ID'), 102)); ?>
            </div>
                    ...
                    <div class="mkd-author-social-holder clearfix">
                        <?php foreach($social_networks as $network) { ?>
                            <a href="<?php echo esc_url($network['link']) ?>" target="blank">
                                <?php echo topfit_mikado_icon_collections()->renderIcon($network['class'], 'font_elegant'); ?>
                            </a>
                        <?php } ?>
                    </div>
