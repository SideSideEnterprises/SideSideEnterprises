<article id="post-<?php the_ID(); ?>" <?php post_class($post_class); ?>>
	<?php topfit_mikado_get_module_template_part('templates/lists/parts/image', 'blog', '', array('image_size' => $image_size)); ?>
	...
	<a class="mkd-video-post-link" href="<?php echo esc_url($_video_link); ?>"
	   data-rel="prettyPhoto[<?php the_ID(); ?>]">
		<?php echo topfit_mikado_icon_collections()->renderIcon('arrow_triangle-right_alt2', 'font_elegant', array('icon_attributes' => array('class' => 'mkd-vb-play-icon'))); ?>
	</a>
</article>