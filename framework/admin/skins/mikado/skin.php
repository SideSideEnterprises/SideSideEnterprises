...
class TopFitMikadoSkin extends TopFitMikadoSkinAbstract {
    /**
     * Skin constructor. Hooks to topfit_mikado_admin_scripts_init and topfit_mikado_enqueue_admin_styles
     */
    public function __construct() {
        $this->skinName = 'mikado';

        //hook to
        add_action('topfit_mikado_admin_scripts_init', array($this, 'registerStyles'));
        add_action('topfit_mikado_admin_scripts_init', array($this, 'registerScripts'));

        add_action('topfit_mikado_enqueue_admin_styles', array($this, 'enqueueStyles'));
        add_action('topfit_mikado_enqueue_admin_scripts', array($this, 'enqueueScripts'));

        add_action('topfit_mikado_enqueue_meta_box_styles', array($this, 'enqueueMetaStyles'));
        add_action('topfit_mikado_enqueue_meta_box_scripts', array($this, 'enqueueScripts'));
    ...
    public function registerScripts() {
        ...
        foreach ($this->scripts as $scriptHandle => $scriptPath) {
            topfit_mikado_register_skin_script($scriptHandle, $scriptPath);
        }
    }
    ...
    public function registerStyles() {
        ...
        foreach ($this->styles as $styleHandle => $stylePath) {
            topfit_mikado_register_skin_style($styleHandle, $stylePath);
        }
    ...
    public function renderOptions() {
        ...
        $tab    		= topfit_mikado_get_admin_tab();
        $active_page 	= $topfit_Framework->mkdOptions->getAdminPageFromSlug($tab);
     ...
     *
*@param TopFitMikadoAdminPage $page current page to load
...
*@param TopFitMikadoAdminPage $page current page to load
    ...
    public function renderImport() { ?>
        <div class="mkd-options-page mkd-page">
            <?php $this->getHeader(topfit_mikado_get_theme_info_item('Name'), topfit_mikado_get_theme_info_item('Version'), false); ?>
            <div class="mkd-page-content-wrapper">
                <div class="mkd-page-content">
                    <div class="mkd-page-navigation mkd-tabs-wrapper vertical left clearfix">
