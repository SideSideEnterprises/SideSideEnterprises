...
if (!function_exists('topfit_mikado_slider_meta_box_map')) {
	function topfit_mikado_slider_meta_box_map() {
		...
		$slider_meta_box = topfit_mikado_create_meta_box(
			array(
				'scope' => array('slides'),
		...
		topfit_mikado_create_meta_box_field(
			array(
		...
		$video_meta_box = topfit_mikado_create_meta_box(
			array(
				'scope'           => array('slides'),
		...
		$general_meta_box = topfit_mikado_create_meta_box(
			array(
				'scope' => array('slides'),
		...
		$behaviours_meta_box = topfit_mikado_create_meta_box(
			array(
				'scope' => array('slides'),
		...
		$title_style_meta_box = topfit_mikado_create_meta_box(
			array(
				'scope'           => array('slides'),
		...
		$slide_title_border = topfit_mikado_create_meta_box_field(array(
		...
		$subtitle_style_meta_box = topfit_mikado_create_meta_box(
			array(
				'scope' => array('slides'),
		...
		$text_style_meta_box = topfit_mikado_create_meta_box(
			array(
				'scope' => array('slides'),
		...
		$buttons_style_meta_box = topfit_mikado_create_meta_box(
			array(
				'scope' => array('slides'),
		...
		$content_positioning_meta_box = topfit_mikado_create_meta_box(
			array(
				'scope' => array('slides'),
