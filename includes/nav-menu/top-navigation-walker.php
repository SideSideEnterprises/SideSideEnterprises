 ...
 */
if(!class_exists('TopFitMikadoTopNavigationWalker')) {
	class TopFitMikadoTopNavigationWalker extends Walker_Nav_Menu {
		...
		function start_lvl(&$output, $depth = 0, $args = array()) {
			...
			if($depth == 0) {
				$out_div = '<div class="second '.$background_image_class.'" '.topfit_mikado_get_inline_style($menu_image_background).'><div class="inner">';
			} else {
				$out_div = '';
			}
...
//                    $item_output .= '<span class="mkd-menu-arrow arrow_carrot-down"></span>';
//                }
