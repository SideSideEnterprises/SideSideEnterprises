...
if (!function_exists('topfit_mikado_styles')) {
	...
	function topfit_mikado_styles() {
		wp_register_style('topfit-mikado-blog', MIKADO_ASSETS_ROOT . '/css/blog.min.css');

		//include theme's core styles
		wp_enqueue_style('topfit-mikado-default-style', MIKADO_ROOT . '/style.css');
		wp_enqueue_style('topfit-mikado-modules-plugins', MIKADO_ASSETS_ROOT . '/css/plugins.min.css');
		...
		if (topfit_mikado_is_woocommerce_installed()) {
			if (topfit_mikado_load_woo_assets() || topfit_mikado_is_ajax_enabled()) {
				...
				wp_enqueue_style('topfit-mikado-woocommerce', MIKADO_ASSETS_ROOT . '/css/woocommerce.min.css');
			}
		}

		wp_enqueue_style('topfit-mikado-modules', MIKADO_ASSETS_ROOT . '/css/modules.min.css');

		topfit_mikado_icon_collections()->enqueueStyles();

		if (topfit_mikado_load_blog_assets()) {
			wp_enqueue_style('topfit-mikado-blog');
		}

		//define files afer which style dynamic needs to be included. It should be included last so it can override other files
		$style_dynamic_deps_array = array();
		if (topfit_mikado_load_woo_assets() || topfit_mikado_is_ajax_enabled()) {
			$style_dynamic_deps_array[] = 'topfit-mikado-woocommerce';
		}

		//is responsive option turned on?
		if (topfit_mikado_is_responsive_on()) {
			wp_enqueue_style('topfit-mikado-modules-responsive', MIKADO_ASSETS_ROOT . '/css/modules-responsive.min.css');
			wp_enqueue_style('topfit-mikado-blog-responsive', MIKADO_ASSETS_ROOT . '/css/blog-responsive.min.css');
			...
			if (topfit_mikado_is_woocommerce_installed()) {
				if (topfit_mikado_load_woo_assets() || topfit_mikado_is_ajax_enabled()) {
					...
					wp_enqueue_style('topfit-mikado-woocommerce-responsive', MIKADO_ASSETS_ROOT . '/css/woocommerce-responsive.min.css');
					$style_dynamic_deps_array[] = 'topfit-mikado-woocommerce-responsive';
				}
			}
			...
			if (file_exists(MIKADO_ROOT_DIR . '/assets/css/style_dynamic_responsive.css') && topfit_mikado_is_css_folder_writable() && !is_multisite()) {
				wp_enqueue_style('topfit-mikado-style-dynamic-responsive', MIKADO_ASSETS_ROOT . '/css/style_dynamic_responsive.css', array(), filemtime(MIKADO_ROOT_DIR . '/assets/css/style_dynamic_responsive.css'));
			}
		}

		if (file_exists(MIKADO_ROOT_DIR . '/assets/css/style_dynamic.css') && topfit_mikado_is_css_folder_writable() && !is_multisite()) {
			wp_enqueue_style('topfit-mikado-style-dynamic', MIKADO_ASSETS_ROOT . '/css/style_dynamic.css', $style_dynamic_deps_array, filemtime(MIKADO_ROOT_DIR . '/assets/css/style_dynamic.css')); //it must be included after woocommerce styles so it can override it
		}
...
if (!function_exists('topfit_mikado_google_fonts_styles')) {
	...
	function topfit_mikado_google_fonts_styles() {
		...
		if (count($fonts_array) > 0) {
			...
			wp_enqueue_style('topfit-mikado-google-fonts', esc_url_raw($topfit_fonts), array(), '1.0.0');
...
if (!function_exists('topfit_mikado_scripts')) {
	...
	function topfit_mikado_scripts() {
        ...
        wp_enqueue_script('hover-intent', MIKADO_ASSETS_ROOT . '/js/modules/plugins/jquery.hoverIntent.min.js', array('jquery'), false, true);
        ...
        wp_enqueue_script('easy-pie-chart', MIKADO_ASSETS_ROOT . '/js/modules/plugins/easypiechart.js', array('jquery'), false, true);
        wp_enqueue_script('stretch', MIKADO_ASSETS_ROOT . '/js/modules/plugins/jquery.stretch.js', array('jquery'), false, true);
        ...
        wp_enqueue_script('fluid-vids', MIKADO_ASSETS_ROOT . '/js/modules/plugins/fluidvids.min.js', array('jquery'), false, true);
        wp_enqueue_script('pretty-photo', MIKADO_ASSETS_ROOT . '/js/modules/plugins/jquery.prettyPhoto.js', array('jquery'), false, true);
        wp_enqueue_script('nice-scroll', MIKADO_ASSETS_ROOT . '/js/modules/plugins/jquery.nicescroll.min.js', array('jquery'), false, true);
        wp_enqueue_script('scroll-to', MIKADO_ASSETS_ROOT . '/js/modules/plugins/ScrollToPlugin.min.js', array('jquery'), false, true);
        wp_enqueue_script('tween-lite', MIKADO_ASSETS_ROOT . '/js/modules/plugins/TweenLite.min.js', array('jquery'), false, true);
        wp_enqueue_script('timeline-lite', MIKADO_ASSETS_ROOT . '/js/modules/plugins/TimelineLite.min.js', array('jquery'), false, true);
        wp_enqueue_script('css-plugin', MIKADO_ASSETS_ROOT . '/js/modules/plugins/CSSPlugin.min.js', array('jquery'), false, true);
        wp_enqueue_script('ease-pack', MIKADO_ASSETS_ROOT . '/js/modules/plugins/EasePack.min.js', array('jquery'), false, true);
        wp_enqueue_script('mix-it-up', MIKADO_ASSETS_ROOT . '/js/modules/plugins/jquery.mixitup.min.js', array('jquery'), false, true);
        wp_enqueue_script('multi-scroll', MIKADO_ASSETS_ROOT . '/js/modules/plugins/jquery.multiscroll.min.js', array('jquery'), false, true);
        wp_enqueue_script('wait-for-images', MIKADO_ASSETS_ROOT . '/js/modules/plugins/jquery.waitforimages.js', array('jquery'), false, true);
        wp_enqueue_script('infinite-scroll', MIKADO_ASSETS_ROOT . '/js/modules/plugins/jquery.infinitescroll.min.js', array('jquery'), false, true);
        ...
        wp_enqueue_script('bootstrap-carousel', MIKADO_ASSETS_ROOT . '/js/modules/plugins/bootstrapCarousel.js', array('jquery'), false, true);
        wp_enqueue_script('touch-swipe', MIKADO_ASSETS_ROOT . '/js/modules/plugins/jquery.touchSwipe.min.js', array('jquery'), false, true);
        wp_enqueue_script('flexslider', MIKADO_ASSETS_ROOT . '/js/modules/plugins/jquery.flexslider-min.js', array('jquery'), false, true);
        wp_enqueue_script('twentytwenty', MIKADO_ASSETS_ROOT . '/js/modules/plugins/jquery.twentytwenty.js', array('jquery'), false, true);
        wp_enqueue_script('event-move', MIKADO_ASSETS_ROOT . '/js/modules/plugins/jquery.event.move.js', array('jquery'), false, true);
		...
		if (topfit_mikado_is_smoth_scroll_enabled()) {
			wp_enqueue_script("topfit-mikado-smooth-page-scroll", MIKADO_ASSETS_ROOT . "/js/smoothPageScroll.js", array(), false, true);
		}
		...
		wp_enqueue_script('topfit-mikado-modules', MIKADO_ASSETS_ROOT . '/js/modules.min.js', array('jquery'), false, true);

		if (topfit_mikado_load_blog_assets()) {
			wp_enqueue_script('topfit-mikado-blog', MIKADO_ASSETS_ROOT . '/js/blog.min.js', array('jquery'), false, true);
		}
...
if (!function_exists('topfit_mikado_sidebar_layout')) {
	...
	function topfit_mikado_sidebar_layout() {
		...
		if (($page_sidebar_meta !== '') && $page_id !== -1) {
			...
			} elseif ( ! empty( $sidebar_layout ) && ! is_active_sidebar( topfit_mikado_get_sidebar() ) ) {
                $sidebar_layout = '';
            }
		}
...
if (!function_exists('topfit_mikado_page_custom_style')) {
	...
	function topfit_mikado_page_custom_style() {
		$style = apply_filters('topfit_mikado_add_page_custom_style', $style = array());
		if (is_array($style) && count($style)) {
			wp_add_inline_style('topfit-mikado-modules', implode(' ', $style));
		}
	}

    add_action('wp_enqueue_scripts', 'topfit_mikado_page_custom_style');
}
...
if (!function_exists('topfit_mikado_print_custom_css')) {
	...
	function topfit_mikado_print_custom_css() {
		...
		if ($custom_css !== '') {
			wp_add_inline_style('topfit-mikado-modules', $custom_css);
		}
	}
...
if (!function_exists('topfit_mikado_print_custom_js')) {
	...
	function topfit_mikado_print_custom_js() {
		...
		if ($custom_js !== '') {
			wp_add_inline_script('topfit-mikado-modules', $custom_js);
		}
	}
...
if (!function_exists('topfit_mikado_per_page_js_variables')) {
	...
	function topfit_mikado_per_page_js_variables() {
		...
		wp_localize_script('topfit-mikado-modules', 'mkdPerPageVars', array(
...
if ( ! function_exists( 'topfit_mikado_is_gutenberg_installed' ) ) {
    /**
     * Function that checks if Gutenberg plugin installed
     */
    function topfit_mikado_is_gutenberg_installed() {
...
add_action( 'admin_enqueue_scripts', 'topfit_mikado_is_gutenberg_installed' );

if ( ! function_exists( 'topfit_mikado_is_plugin_installed' ) ) {
    /**
     ...
     * @return bool
     */
    function topfit_mikado_is_plugin_installed( $plugin ) {
        switch ( $plugin ) {
            case 'core':
...
if ( ! function_exists('topfit_mikado_get_module_part') ) {
    function topfit_mikado_get_module_part( $module ) {
        return $module;
    }
}

if ( ! function_exists( 'topfit_mikado_enqueue_editor_customizer_styles' ) ) {
    /**
     * Enqueue supplemental block editor styles
     */
    function topfit_mikado_enqueue_editor_customizer_styles() {
        wp_enqueue_style( 'topfit-style-modules-admin-styles', MIKADO_FRAMEWORK_ADMIN_ASSETS_ROOT . '/css/mkd-modules-admin.css' );
        wp_enqueue_style( 'topfit-style-handle-editor-customizer-styles', MIKADO_FRAMEWORK_ADMIN_ASSETS_ROOT . '/css/editor-customizer-style.css' );
    }

    // add google font
    add_action( 'enqueue_block_editor_assets', 'topfit_mikado_google_fonts_styles' );
    // add action
    add_action( 'enqueue_block_editor_assets', 'topfit_mikado_enqueue_editor_customizer_styles' );
}
